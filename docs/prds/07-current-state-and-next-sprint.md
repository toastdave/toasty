...
- tournament setup is only in its first heuristic snapshot form and still needs stricter official freeze rules and bracket generation
...
4. harden the stored seeding snapshot into official freeze, rerun, and bracket-generation rules
